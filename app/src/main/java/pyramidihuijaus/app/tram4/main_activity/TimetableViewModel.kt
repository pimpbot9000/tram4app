...
import pyramidihuijaus.app.tram4.api.TramService
import pyramidihuijaus.app.tram4.utils.SensibleTimer
...
class TimetableViewModel : ViewModel() {
    ...
    private val tramService: TramService =
        TramService(HttpUrl.parse(TramService.BASE_URL)!!)
    private val compositeDisposable = CompositeDisposable()
    private var stop: String? = null
    private val timer = SensibleTimer(4900L) {
        refreshTimeTable()
    }
