...
import pyramidihuijaus.app.tram4.settings_activity.SettingsActivity
import pyramidihuijaus.app.tram4.utils.StringUtils
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        stopTextView.setOnClickListener { startSettingsActivity() }
    ...
    override fun onStart() {
        ...
        val stop = prefs.getString("stop", resources.getString(R.string.default_stop)) // default
